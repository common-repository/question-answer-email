...
$templates_data_html['new_question_submitted'] = '<div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
...
<a style="text-decoration: none; color: #51b3ff;font-size:15px;" href="{question_url}">{question_title}</a><br />
{question_content}</p>
<div style="padding: 10px 0 0;"><a class="btn" style="color: #fff; border-radius: 3px; text-decoration: none; background-color: #51b3ff; padding: 10px 20px; font-size: 14px; font-family: Arial, sans-serif;" href="{question_edit_url}">Edit/Approved Question</a></div>
</td>
</tr>
</tbody>
</table>
