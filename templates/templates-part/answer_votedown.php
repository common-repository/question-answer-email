...
$templates_data_html['answer_votedown'] = '<div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
...
<a style="text-decoration: none; color: #51b3ff;font-size:15px;" href="{answer_url}">{answer_title}</a> <br/>
{answer_content}</p>
